let InsertProductQuantity = function (ncUtil,
                               channelProfile,
                               flowContext,
                               payload,
                               callback) {
        ...
        try {
            ...
            request(options, function (error, response, body) {
                if (!error) {
                    ...
                    log("Do InsertProductQuantity Callback", ncUtil);
                    ...
                    if (data && response.statusCode == 200) {
                        out.payload = {
                            doc: data,
                            "productQuantityRemoteID": data.Id,
                    ...
                    logError("Do InsertProductQuantity Callback error - " + error, ncUtil);
                    out.ncStatusCode = 500;
            ...
            logError("Exception occurred in InsertProductQuantity - " + err, ncUtil);
            out.ncStatusCode = 500;
...
module.exports.InsertProductQuantity = InsertProductQuantity;
