...
let InsertProductQuantity = function (
  ncUtil,
  channelProfile,
  flowContext,
  payload,
    ...
    try {
      ...
      request(options, function (error, response, body) {
        if (!error) {
          ...
          log("Do InsertProductQuantity Callback");
          ...
          logError("Do InsertProductQuantity Callback error - " + error);
          out.ncStatusCode = 500;
      ...
      logError("Exception occurred in InsertProductQuantity - " + err);
      out.ncStatusCode = 500;
